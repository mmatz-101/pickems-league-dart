...
class GamesWithUrlsTable extends SupabaseTable<GamesWithUrlsRow> {
  @override
  String get tableName => 'games_with_urls';

  @override
  GamesWithUrlsRow createRow(Map<String, dynamic> data) =>
      GamesWithUrlsRow(data);
}

class GamesWithUrlsRow extends SupabaseDataRow {
  GamesWithUrlsRow(super.data);

  @override
  SupabaseTable get table => GamesWithUrlsTable();
  ...
  set awayShortName(String? value) =>
      setField<String>('away_short_name', value);
  ...
  set homeShortName(String? value) =>
      setField<String>('home_short_name', value);
  ...
  String? get homeImageSrc => getField<String>('home_image_src');
  set homeImageSrc(String? value) => setField<String>('home_image_src', value);

  String? get awayImageSrc => getField<String>('away_image_src');
  set awayImageSrc(String? value) => setField<String>('away_image_src', value);
}
