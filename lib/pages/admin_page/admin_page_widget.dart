                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            _model.gameResult =
                                                await GetOddsharkDataCall.call(
                                              league:
                                                  _model.textController2.text,
                                              year: _model.textController1.text,
                                              weekSuffix:
                                                  _model.textController3.text,
                                            );
                                            if ((_model.gameResult?.succeeded ??
                                                true)) {
                                              await actions
                                                  .uploadGamesJsonAction(
                                                GetOddsharkDataCall.games(
                                                  (_model.gameResult
                                                          ?.jsonBody ??
                                                      ''),
                                                ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            await GlobalVarTable().update(
                                              data: {
                                                'current_week': int.tryParse(
                                                    _model
