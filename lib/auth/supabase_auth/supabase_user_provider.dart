...
class PickemsLeagueSupabaseUser extends BaseAuthUser {
  PickemsLeagueSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> pickemsLeagueSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = PickemsLeagueSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
